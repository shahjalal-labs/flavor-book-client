  ...
  return (
    <>
      <motion.div
        ...
        className="rounded-lg hover:shadow-md transition duration-300 max-w-[350px] shadow-xl bg-gradient-to-r from-primary/10 via-secondary/10 via-cyan-900 to-accent/10 max-sm:min-w-[300px] "
      >
        <img
