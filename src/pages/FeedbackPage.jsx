...
const FeedbackPage = () => {
  return (
    <div className="mx-auto p-6 mt-10 bg-accent/10 rounded-xl">
...
const FeedbackPage = () => {
  return (
    <div className="mx-auto p-6 mt-10 bg-gray-900/80 rounded-xl">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {feedbacks.map((fb, i) => (
          <div
            key={i}
            className="shadow-lg p-6 rounded-xl border border-indigo-600 hover:scale-105 transition-transform duration-300 ease-in-out hover:shadow-indigo-500/40
 bg-gradient-to-br from-gray-900/70 via-gray-950/60 to-gray-900/80"
          >
            <div className="flex items-center gap-4 mb-4">
              <img
                src={fb.avatar}
            ...
            <p className="text-slate-300 italic mb-2">{fb.comment}</p>
            <div className="text-3xl">{fb.emoji}</div>
          </div>
        ))}
      </div>
      ...
      <div className="text-center mt-12">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="mx-auto h-20 w-20 text-indigo-400 animate-bounce"
          viewBox="0 0 24 24"
          fill="currentColor"
        >
          <path
